...
const LivePreview = forwardRef<HTMLDivElement>((props, ref) => {
  ...
  return (
    ...
    >
      <div 
        ref={ref}
        className="cv-container bg-white w-[210mm] min-h-[297mm] p-[12mm_15mm] shrink-0
        ...
        <div className="prose max-w-none 
          ...
          prose-p:text-center prose-p:mb-3 prose-p:text-[12px] prose-p:text-[#525252] prose-p:whitespace-pre-wrap prose-p:leading-tight
          prose-h2:text-[13px] prose-h2:font-bold prose-h2:mt-4 prose-h2:mb-1.5 prose-h2:uppercase prose-h2:border-b prose-h2:border-[#262626] prose-h2:pb-1 prose-h2:text-[#171717]
          prose-h3:text-[12.5px] prose-h3:font-bold prose-h3:mt-2 prose-h3:mb-1 prose-h3:text-[#171717]
